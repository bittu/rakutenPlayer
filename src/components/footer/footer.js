...
const footer = () => {
    return (
        ...
        <div className="footer_info">
            ...
            <p className="footer_info_text">Rakuten TV provides a combination of services that offer a universe of content 
            in just a fews clicks. Enjoy a true cinematic experience with the latest new releases, premium subscription 
